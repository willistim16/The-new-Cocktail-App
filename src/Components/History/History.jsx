import '/src/Components/History/History.css'
            ...
            <div className="history-outer-container">
                ...
                <div className="history-container">
                    ...
                    <p>In de 19e eeuw werden cocktails steeds populairder in de Verenigde Staten, vooral door de
                        ontwikkeling
                        van nieuwe mengtechnieken en de beschikbaarheid van een grotere verscheidenheid aan
                        ingrediënten.
                ...
                <div className="history-container">
                    ...
                    <p>Na Prohibition werd drinken weer legaal, en cocktails verspreidden zich verder over de wereld.
                        Vooral na
                        de Tweede Wereldoorlog, toen Amerikaanse soldaten in contact kwamen met nieuwe dranken en
                        mixtechnieken,
                        begon de &#34;cocktailcultuur&#34; een internationale invloed te krijgen. Tijdens de
                        jaren &#39;50
                ...
                <div className="history-container">
                    ...
                    <p>In de jaren &#39;80 en &#39;90 raakten cocktails uit de gratie door de populariteit van
                        eenvoudigere
                        mixdranken. Maar in de vroege jaren 2000 begon een cocktailrenaissance. Bartenders
                        experimenteerden
                        opnieuw met klassieke recepten, ambachtelijke ingrediënten en nieuwe smaken, wat leidde tot de
                        opkomst
                        van ambachtelijke cocktails. Klassieke cocktails kregen nieuwe populariteit en bartenders
                        begonnen
                ...
                <div className="history-container">
                    ...
                    <p>Vandaag de dag zijn cocktails een wereldwijd fenomeen, waarbij bartenders zich blijven vernieuwen
                        en
                        trends omarmen zoals duurzaamheid, lokale ingrediënten, en alcoholvrije cocktails. De kunst van
                        het
                        maken van cocktails is geëvolueerd tot een complex vak waarin bartenders worden gewaardeerd als
                        culinaire ambachtslieden. Deze evolutie van simpele mixdranken naar verfijnde creaties
                        weerspiegelt de voortdurende
                        zoektocht naar
